...
| --- | --- | --- | --- |
| [`kpil`](https://github.com/qjoly/kpil) | Spin up a GitHub Copilot CLI container with a read-only (no-secrets) kubeconfig | v0.2.0 | `brew install qjoly/tap/kpil` |
...
| [`talosctl-oidc`](https://github.com/qjoly/talosctl-oidc) | OIDC certificate exchange server and client for Talos Linux | v0.1.1 | `brew install qjoly/tap/talosctl-oidc` |
