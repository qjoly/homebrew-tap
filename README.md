...
| [`talosctl-oidc`](https://github.com/qjoly/talosctl-oidc) | OIDC certificate exchange server and client for Talos Linux | v0.1.2 | `brew install qjoly/tap/talosctl-oidc` |
